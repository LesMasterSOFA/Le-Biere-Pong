...
namespace AtelierXNA
{
   ...
   class EnvironnementSalleManger : Microsoft.Xna.Framework.DrawableGameComponent
   {
      ...
      public EnvironnementSalleManger(Game game, GestionEnvironnement gestionEnv, string nomGauche, string nomDroite, string nomPlafond, string nomPlancher, string nomAvant, string nomArrière,

...
namespace AtelierXNA
{
    public class ObjetDeBase : DrawableGameComponent
    {
        ...
        RessourcesManager<Effect> GestionShaders { get; set; }
        ...
        protected override void LoadContent()
        {
            ...
            GestionShaders = Game.Services.GetService(typeof(RessourcesManager<Effect>)) as RessourcesManager<Effect>;
            
            EffetShader = GestionShaders.Find(NomEffet);

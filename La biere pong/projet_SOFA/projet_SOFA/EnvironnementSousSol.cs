...
namespace AtelierXNA
{
    ...
    class EnvironnementSousSol : Microsoft.Xna.Framework.DrawableGameComponent
    {
        ...
        public EnvironnementSousSol(Game game, string nomGauche, string nomDroite, string nomPlafond, string nomPlancher, string nomAvant, string nomArrière)
            : base(game)
       {
           NomGauche = nomGauche;
           NomDroite = nomDroite;
       ...
       public override void Initialize()
       {
           ...
           FixerLesPositions();
           //personnagePrincipal = new Personnage(this.Game, new Vector3(0,0,-1f));

...
namespace AtelierXNA
{
    ...
    public class ModePratique : PartieSolo
    {
        ...
        {
            EnvironnementPartie = new GestionEnvironnement(Game, Environnements.Garage, SuperboyPersonnage.superBoy.ToString(), SuperboyPersonnage.superBoyTex.ToString(), SuperboyPersonnage.superBoy.ToString(), SuperboyPersonnage.superBoyTex2.ToString(),TypePartie.Pratique);
            ModifierActivation();
            if (EstPartieActive)
            {
        ...
        {
            EnvironnementPartie = new GestionEnvironnement(Game, Environnements.SalleManger, SuperboyPersonnage.superBoy.ToString(), SuperboyPersonnage.superBoyTex.ToString(), SuperboyPersonnage.superBoy.ToString(), SuperboyPersonnage.superBoyTex2.ToString(),TypePartie.Pratique);
            ModifierActivation();
            if (EstPartieActive)
            {
                Game.Components.Add(EnvironnementPartie);
        ...
        {
            EnvironnementPartie = new GestionEnvironnement(Game, Environnements.SousSol, SuperboyPersonnage.superBoy.ToString(), SuperboyPersonnage.superBoyTex.ToString(), SuperboyPersonnage.superBoy.ToString(), SuperboyPersonnage.superBoyTex2.ToString(),TypePartie.Pratique);
            ModifierActivation();
            if (EstPartieActive)
            {
                Game.Components.Add(EnvironnementPartie);
